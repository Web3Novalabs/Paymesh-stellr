  ...
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-lg border p-4 pr-8 shadow-lg transition-all",
  {
    variants: {
      variant: {
        ...
        success: "bg-secondary text-secondary-foreground border-green-500",
        error: "bg-secondary text-secondary-foreground border-destructive",
        warning: "bg-secondary text-secondary-foreground border-yellow-500",
        info: "bg-secondary text-secondary-foreground border-primary",
      },
    },
    defaultVariants: {
      variant: "default",
